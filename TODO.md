...
* Consider library like langchain or LiteLLM to abstract out how tool results are returned.
  * https://learn.microsoft.com/en-us/azure/ai-foundry/openai/api-version-lifecycle?view=foundry-classic&tabs=python
  * ResponsesAPI instead of ChatCompletionAPI
  * https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-models/how-to/generate-responses?view=foundry-classic&tabs=python
* MCP sample
  * . Write explanations
  ...
  * x Model has some console spew
  * Test calc, dag, menu - update README for samples
  * Should format_messages use ChatCompletionMessageParam?
* Design challenge:
