...
def stages(name, config: Configuration, registry: Registry):
    ...
    async def assess(context: dict[str, Any], turn_index: int, isolated_turn: bool):
        return 0 if context["stages"]["extract"] == context["case"]["answer"] else 1
